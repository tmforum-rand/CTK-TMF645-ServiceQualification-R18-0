...
var DefaultURL = "http://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceQualificationManagement/v3/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "serviceQualification";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF645 ServiceQualification\n");
getURL();
...
function getURL(){
    ...
    rl.question('////////////////////////////////////////////////////////////////////////\nWhat is your full API address omiting the endpoint? example:\nhttps://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceQualificationManagement/v3/serviceQualification\nbecomes\nhttps://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceQualificationManagement/v3/\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF645-ServiceQualification.postman_collection.json'),
